...
const AUTHORS: Record<string, AuthorData> = {
  "Ayush Singh": {
    ...
    socials: {
      ...
      linkedin: "https://linkedin.com/in/ayushsingh",
    },
    interests: [
      {
            ...
            {(["Ayush Singh", "Krishika"] as const).map((name) => {
              ...
              return (
                <button
                  ...
                  className={`relative px-8 py-3 rounded-full text-xs font-bold tracking-[0.15em] uppercase transition-colors duration-300 z-10 ${
